 ...
 * 版    本：1.0.0
 * 日    期：2018/1/26
 * 权    限：android.permission.SYSTEM_ALERT_WINDOW
 * 说    明：适配 8.0 需要窗口权限、强调类型是没有点击事件
 * ================================================
 */
public class UniversalToast {
    ...
    public void showSuccess() {
        setIcon(type == EMPHASIZE ? R.drawable.toast_ic_check : R.drawable.toast_ic_done);
        show();
    }

    public void showError() {
        setIcon(R.drawable.toast_ic_close);
        show();
    }

    public void showWarning() {
        setIcon(R.drawable.toast_ic_error);
        show();
    }

    public UniversalToast setClickCallBack(@NonNull String text, @NonNull View.OnClickListener listener) {
        return setClickCallBack(text, R.drawable.toast_ic_arrow, listener);
    }

    public UniversalToast setClickCallBack(@NonNull View.OnClickListener listener) {
        return setClickCallBack(text, R.drawable.toast_ic_arrow, listener);
    }
    ...
    public UniversalToast setClickCallBack(@NonNull String text, @DrawableRes int resId, @NonNull View.OnClickListener listener) {
        ...
        LinearLayout layout = view.findViewById(R.id.btn);
